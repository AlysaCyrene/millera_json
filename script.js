    ...
    .then(users => {
        ...
        users.forEach(user => {
            const userCard = `
                <div class="col-md-4">
                    <div class="card mb-4">
                        <div class="card-body " style= "background-color: violet; color: black">
                            <h5 class="card-title" style="font-weight:bold; color:#333333;">${user.name}</h5>
            ...
            const photoCard = `
                <div class="col-md-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body" style= "background-color: #d896ff; color: black>
